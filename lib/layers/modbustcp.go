...
var LayerTypeModbusTCP gopacket.LayerType
...
func (d *ModbusTCP) LayerType() gopacket.LayerType {
	LayerTypeModbusTCP = gopacket.OverrideLayerType(141, gopacket.LayerTypeMetadata{Name: "ModbusTCP", Decoder: gopacket.DecodeFunc(decodeModbusTCP)})
...
func (d *ModbusTCP) DecodeFromBytes(data []byte, df gopacket.DecodeFeedback) error {
	...
	d.BaseLayer = layers.BaseLayer{Contents: data[:mbapRecordSizeInBytes], Payload: data[mbapRecordSizeInBytes:len(data)]}
